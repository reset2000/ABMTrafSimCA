...
\hypertarget{_condition_estimator_8h_source}{}\label{_condition_estimator_8h_source}\index{Eigen/src/Core/ConditionEstimator.h@{Eigen/src/Core/ConditionEstimator.h}}
...
\DoxyCodeLine{00020\ \ \ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{class_eigen_1_1_matrix_base}{RealVector}}\ \mbox{\hyperlink{class_eigen_1_1_matrix_base}{v\_abs}}\ =\ v.cwiseAbs();}
\DoxyCodeLine{00021\ \ \ \ \ \textcolor{keywordflow}{return}\ (\mbox{\hyperlink{class_eigen_1_1_matrix_base}{v\_abs}}.\mbox{\hyperlink{class_eigen_1_1_matrix_base_a6bd01a3c94daf864579f14510aa320f8}{array}}()\ ==\ \textcolor{keyword}{static\_cast<}\mbox{\hyperlink{class_eigen_1_1_matrix_base}{typename}}\ Vector::RealScalar\textcolor{keyword}{>}(0))}
\DoxyCodeLine{00022\ \ \ \ \ \ \ \ \ \ \ \ \ .\mbox{\hyperlink{class_eigen_1_1_dense_base_a4b481a88facffd21b91754fba205607d}{select}}(Vector::Ones(v.size()),\ v.cwiseQuotient(\mbox{\hyperlink{class_eigen_1_1_matrix_base}{v\_abs}}));}
\DoxyCodeLine{00023\ \ \ \}}
\DoxyCodeLine{00024\ \};}
\DoxyCodeLine{00025\ }
...
\DoxyCodeLine{00028\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{struct_eigen_1_1internal_1_1rcond__compute__sign}{rcond\_compute\_sign}}<Vector,\ Vector,\ \mbox{\hyperlink{class_eigen_1_1_matrix_base}{false}}>\ \{}
\DoxyCodeLine{00029\ \ \ \textcolor{keyword}{static}\ \textcolor{keyword}{inline}\ Vector\ run(\textcolor{keyword}{const}\ Vector\&\ v)\ \{}
\DoxyCodeLine{00030\ \ \ \ \ \textcolor{keywordflow}{return}\ (v.array()\ <\ \textcolor{keyword}{static\_cast<}\mbox{\hyperlink{class_eigen_1_1_matrix_base}{typename}}\ Vector::RealScalar\textcolor{keyword}{>}(0))}
\DoxyCodeLine{00031\ \ \ \ \ \ \ \ \ \ \ \ .\mbox{\hyperlink{class_eigen_1_1_dense_base_a4b481a88facffd21b91754fba205607d}{select}}(-\/Vector::Ones(v.size()),\ Vector::Ones(v.size()));}
\DoxyCodeLine{00032\ \ \ \}}
\DoxyCodeLine{00033\ \};}
\DoxyCodeLine{00034\ }
\DoxyCodeLine{00055\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ Decomposition>}
\DoxyCodeLine{00056\ \textcolor{keyword}{typename}\ Decomposition::RealScalar\ rcond\_invmatrix\_L1\_norm\_estimate(\textcolor{keyword}{const}\ \mbox{\hyperlink{class_eigen_1_1_matrix_base}{Decomposition}}\&\ dec)}
\DoxyCodeLine{00057\ \{}
...
\DoxyCodeLine{00062\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ \mbox{\hyperlink{struct_eigen_1_1internal_1_1true__type}{internal::plain\_col\_type<MatrixType,\ RealScalar>::type}}\ \mbox{\hyperlink{class_eigen_1_1_matrix_base}{RealVector}};}
\DoxyCodeLine{00063\ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{class_eigen_1_1_matrix_base}{is\_complex}}\ =\ (\mbox{\hyperlink{struct_eigen_1_1_num_traits}{NumTraits<Scalar>::IsComplex}}\ !=\ 0);}
\DoxyCodeLine{00064\ }
\DoxyCodeLine{00065\ \ \ eigen\_assert(dec.rows()\ ==\ dec.cols());}
\DoxyCodeLine{00066\ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ n\ =\ dec.rows();}
...
\DoxyCodeLine{00084\ \ \ RealScalar\ lower\_bound\ =\ v.template\ \mbox{\hyperlink{class_eigen_1_1_matrix_base}{lpNorm<1>}}();}
...
\DoxyCodeLine{00091\ \ \ RealScalar\ \mbox{\hyperlink{class_eigen_1_1_matrix_base}{old\_lower\_bound}}\ =\ lower\_bound;}
\DoxyCodeLine{00092\ \ \ Vector\ \mbox{\hyperlink{class_eigen_1_1_matrix_base}{sign\_vector}}(n);}
\DoxyCodeLine{00093\ \ \ Vector\ \mbox{\hyperlink{class_eigen_1_1_matrix_base}{old\_sign\_vector}};}
\DoxyCodeLine{00094\ \ \ \mbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ \mbox{\hyperlink{class_eigen_1_1_matrix_base}{v\_max\_abs\_index}}\ =\ -\/1;}
\DoxyCodeLine{00095\ \ \ \mbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ \mbox{\hyperlink{class_eigen_1_1_matrix_base}{old\_v\_max\_abs\_index}}\ =\ \mbox{\hyperlink{class_eigen_1_1_matrix_base}{v\_max\_abs\_index}};}
\DoxyCodeLine{00096\ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{int}\ \mbox{\hyperlink{class_eigen_1_1_matrix_base}{k}}\ =\ 0;\ \mbox{\hyperlink{class_eigen_1_1_matrix_base}{k}}\ <\ 4;\ ++\mbox{\hyperlink{class_eigen_1_1_matrix_base}{k}})}
\DoxyCodeLine{00097\ \ \ \{}
\DoxyCodeLine{00098\ \ \ \ \ \mbox{\hyperlink{class_eigen_1_1_matrix_base}{sign\_vector}}\ =\ \mbox{\hyperlink{struct_eigen_1_1internal_1_1rcond__compute__sign}{internal::rcond\_compute\_sign<Vector,\ RealVector,\ is\_complex>::run}}(v);}
\DoxyCodeLine{00099\ \ \ \ \ \textcolor{keywordflow}{if}\ (\mbox{\hyperlink{class_eigen_1_1_matrix_base}{k}}\ >\ 0\ \&\&\ !\mbox{\hyperlink{class_eigen_1_1_matrix_base}{is\_complex}}\ \&\&\ \mbox{\hyperlink{class_eigen_1_1_matrix_base}{sign\_vector}}\ ==\ \mbox{\hyperlink{class_eigen_1_1_matrix_base}{old\_sign\_vector}})\ \{}
...
\DoxyCodeLine{00104\ \ \ \ \ v\ =\ dec.\mbox{\hyperlink{class_eigen_1_1_matrix_base_a73d8782980bd75141785340d3a7a8e10}{adjoint}}().solve(\mbox{\hyperlink{class_eigen_1_1_matrix_base}{sign\_vector}});}
\DoxyCodeLine{00105\ \ \ \ \ v.real().cwiseAbs().maxCoeff(\&\mbox{\hyperlink{class_eigen_1_1_matrix_base}{v\_max\_abs\_index}});}
\DoxyCodeLine{00106\ \ \ \ \ \textcolor{keywordflow}{if}\ (\mbox{\hyperlink{class_eigen_1_1_matrix_base}{v\_max\_abs\_index}}\ ==\ \mbox{\hyperlink{class_eigen_1_1_matrix_base}{old\_v\_max\_abs\_index}})\ \{}
...
\DoxyCodeLine{00134\ \ \ \textcolor{keywordflow}{for}\ (\mbox{\hyperlink{namespace_eigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ i\ =\ 0;\ i\ <\ n;\ ++i)\ \{}
